...
<body>
	...
	$sql = "SELECT USERS.USER_ID, USERS.TITLE, USERS.FNAME, USERS.LNAME, USERS.PROFILE, POSTS.MESSAGE, POSTS.CREATE_TIME FROM POSTS INNER JOIN USERS ON USERS.USER_ID = POSTS.USER_ID ORDER BY CREATE_TIME DESC";
